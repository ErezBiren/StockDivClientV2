...
import { useGetLastTotalDividendQuery, useGetMarketValueQuery, useGetAverageIncreaseQuery, useGetIncomeLastYearQuery } from "../../features/portfolio/portfolioApiSlice";
